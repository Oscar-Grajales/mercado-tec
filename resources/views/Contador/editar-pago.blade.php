            ...
            <div class="container">  
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="/actualizar-pago/{{$pago->id}}" method="POST">
                            @csrf
                            @method('PUT')
                            <button class="btn btn-warning"><i class="fa fa-refresh"></i>&nbsp; Actualizar pago</button>
                            <br>
                            <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            <th class="text-center">
                                                <input type="checkbox" class="casilla" name="ventas[]" value="{{$venta['id']}}" checked>
                                            </th>

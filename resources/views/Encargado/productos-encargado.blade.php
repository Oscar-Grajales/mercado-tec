@include('header')
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"><a href="/inicio-encargado">Productos No Consignados</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Productos No Consignados</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
		...
		<div class="product-details">
			<div class="buscar-no-consignado">
				...
				<div>			
					<div class="header-search">							
						<form action="/filtro-producto-encargado" method="POST">
			...
			<div class="tabla-de-encargado">
				...
				<div class="fila-tabla-encargado">
					...
					<p>${{$producto->precio}}</p>
					<div>
						<a href="/ver-no-consignado/{{$producto->id}}">
